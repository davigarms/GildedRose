...
namespace GildedRose.Tests.UpdateQualityTests
{
    ...
    public class GivenAProductIsBackstagePasses : GildedRoseTests
    {
        ...
        {
            AddItems("Backstage passes to a TAFKAL80ETC concert", 15, quality);
            App.UpdateQuality();
        ...
        {
            AddItems("Backstage passes to a TAFKAL80ETC concert", 10, quality);
            App.UpdateQuality();
            Assert.That(App.Items[0].Quality, Is.EqualTo(expectedQuality));
        }
        ...
        {
            AddItems("Backstage passes to a TAFKAL80ETC concert", 5, quality);
            App.UpdateQuality();
            Assert.That(App.Items[0].Quality, Is.EqualTo(expectedQuality));
        }
        ...
        {
            AddItems("Backstage passes to a TAFKAL80ETC concert", 0, quality);
            App.UpdateQuality();
            Assert.That(App.Items[0].Quality, Is.EqualTo(expectedQuality));
        }
    }
